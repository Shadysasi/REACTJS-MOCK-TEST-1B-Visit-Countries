...
class Home extends Component {
  ...
  render() {
    ...
    const visitedCountriesResults = list.filter(
        ...
        <CountryList>
          {list.map(eachItem => (
            <CountriesList
              ...
              clickVisitItem={this.clickVisitItem}
            />
          ))}
        </CountryList>
        <VisitedCountriesContainer>
          <Heading>Visited Countries</Heading>
          {visitedCountriesResults.length === 0 ? (
            <EmptyHeader>No Countries Visited Yet</EmptyHeader>
          ) : (
            <VisitedCountriesDisplay>
              {visitedCountriesResults.map(eachItem =>
                eachItem.isVisited ? (
